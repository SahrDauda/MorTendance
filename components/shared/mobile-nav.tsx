...
import { Home, Users, Sparkles, ClipboardCheck } from "lucide-react"
    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border/80 bg-background/95 backdrop-blur-xl lg:hidden pb-[env(safe-area-inset-bottom)] shadow-[0_-4px_24px_rgba(0,0,0,0.12)] select-none">
      <div className="relative flex items-center justify-around h-16 px-4">
        ...
        <Link
          ...
          className={cn(
            "flex flex-1 flex-col items-center justify-center gap-1 h-full py-1 text-[10px] font-bold transition-all active:scale-90 mr-6",
        ...
        <Link
          ...
          className={cn(
            "flex flex-1 flex-col items-center justify-center gap-1 h-full py-1 text-[10px] font-bold transition-all active:scale-90 ml-6",
