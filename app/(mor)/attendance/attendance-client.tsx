...
import { Calendar as CalendarIcon, Check, X, Save, Loader2, Calendar, Users, TrendingUp, UserCheck, Download, Plus, Search as SearchIcon, MoreHorizontal } from "lucide-react"
...
export function AttendanceClient({ initialGroups, allMembers, userRole }: AttendanceClientProps) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (memberIdsToSave.length === 0 && !isAddAttendanceOpen) {
                toast.error("No members to save attendance for")
                return
            }
